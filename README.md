...
#### ✨ Features  
- 🗺️ **Interactive Map**: Displays a fully functional map using OpenStreetMap.  
- 📍 **Shapes Plotted in Map**: Plot Diff Shapes to Seperate it , on different scenarios .  
- 🛣️ **Shape Management**: Plot and visualize coordinates That auto fit zoom.  
...
#### ✨ Features  
- ➕ **Create**: Add new rows of data dynamically.  
- ✏️ **Update**: Edit existing table entries.  
- ❌ **Delete**: Remove rows from the table.  
- 🔎 **Read**: View and interact with structured data in table format.  
- 💾 **Quick Reflect in Db**
#### 🛠️ Technologies Used  
- **Frontend**: HTML, CSS, JavaScript  
